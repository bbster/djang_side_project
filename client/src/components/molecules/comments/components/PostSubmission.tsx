...
import { PostType } from "module/forum/models/Post";
import { PostUtil } from "module/forum/utils/PostUtil";
		...
		>
			<Editor
				...
				handleChange={(html: string) =>
					props.updateFormField("text", html)
				}
			/>
		</div>
